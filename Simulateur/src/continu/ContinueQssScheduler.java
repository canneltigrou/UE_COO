...
public class ContinueQssScheduler {
	...
	private Step step4;
	private Adder adder;
	private QssIntegrateur integrateur;
	...
	private AtomicComponent impactedComponent(IO message) {
		...
		if (message.equals((Object) IOenum.REQ))
			return integrateur;
		if (message.equals((Object) IOenum.DONE))
			System.out.println("HEY ! l'état Q est à : " + message.getValue());
		return null;
	}
	...
	private void run() throws IOException {
		...
		while (!stop) {
			...
			integratedChart.addDataToSeries(temps, integrateur.getCurrentQ());
